Gem::Specification.new do |s|
  ...
  s.homepage     = 'http://github.com/develsadvocates/errortracking'
  s.summary      = 'Handles uncaught exceptions from your application and integrates tightly with your project management tool.'
  s.description  = 'This gem installs the agent of ErrorTracking.net to your application. It handles uncaught exceptions from your application and tightly integrates exceptions with your project management tool.'
